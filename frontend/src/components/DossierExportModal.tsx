  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
      <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-3xl max-h-[90vh] flex flex-col overflow-hidden shadow-2xl">
        ...
        {/* Action Controls */}
        <div className="px-6 py-2.5 border-b border-slate-800 bg-slate-950/40 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={handleCopy}
              className="text-xs px-3 py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 flex items-center gap-1.5 transition cursor-pointer"
            >
            ...
            <button
              ...
              className="text-xs px-3 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white font-medium flex items-center gap-1.5 transition cursor-pointer"
            >
        ...
        {/* Dossier Preview */}
        <div className="p-6 overflow-y-auto flex-1 bg-slate-950/70 font-mono text-xs text-slate-300 whitespace-pre-wrap leading-relaxed">
          {generateDossierText()}
        </div>
      </div>
    </div>
